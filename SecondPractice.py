...
columns_order = list(dataset.columns.difference(["Male", "Female", "Purchased"])) + ["Male", "Female", "Purchased"]  # Corregido aquí

dataset = dataset[columns_order]  # Aplicando el orden correcto de columnas
